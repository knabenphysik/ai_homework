...
![Google Lens & Translate](content/image/intro/google_lens.webp){#fig-ml-google-1 width=70%}
...
![Tesla's AI](content/image/intro/Tesla-object-detection.webp){#fig-ml-teslai width=70%}
...
![Bloomberg NLP](content/image/intro/bloomberg_nlp.webp){#fig-bloomberg-ai width=70%}
...
![Drug Discovery](content/image/intro/drug-desgn.webp){#fig-drug width=40%}
...
![corrosion detection in pipeline](content/image/intro/corrosion_detection.png){#fig-karat width=70%}
...
![ppe detection](content/image/intro/ppe.png){#fig-karat width=40%}
...
![Artificial intelligence, machine learning, and data science.[@KOTU20191]](content/image/intro/relationship.jpg){#fig-ml-kaitan width=70%}
...
![Domain area of deep learning[@Prabhu]](content/image/intro/ml_ops.png){#fig-ml-kaitan width=70%}

MLOps is the process of automating and _**productize**_ machine learning applications and workflows.
...
![Only a small fraction of real-world ML systems is composed of the ML code, as shown by the small black box in the middle. The required surrounding infrastructure is vast and complex.[@NIPS2015_86df7dcf]](content/image/intro/technical_debt.png){#fig-ml-kaitan width=70%}
