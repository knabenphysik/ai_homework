...
knitr::include_graphics("content/image/ai_task.png")
```

## AI vs ML vs DL

```{r compare-ai, echo=FALSE , fig.align = 'center', out.width = "80%", fig.cap = " Figure 2: AI vs ML vs DL"}
knitr::include_graphics("content/image/AI-Circle.png")
```
...
knitr::include_graphics("content/image/cross_domain.png")
```
